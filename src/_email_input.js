...
export default class email_input {
    ...
    init() {
        ...
        self.input.addEventListener('input', function(evt) {
            ...
            let symb = evt.data;
            let step_info = self.check_step();

            console.log( step_info ); 

            if (symb == null) {}

            console.log( step_info['step'] );
            console.log( self.steps[step_info['step']].val );
    ...
    check_step(){
        ...
        if ( r.caretPositionStart >= 0 && r.caretPositionStart <= r.step1  ) {
            //console.log( r.caretPositionStart );
            //console.log(1);
        ...
        }else if( r.caretPositionStart > r.step1 ){
            //console.log( r.caretPositionStart );
            //console.log(3);
            step_data['cursor_pos'] = r.caretPositionStart;
            step_data['step'] = 2;
